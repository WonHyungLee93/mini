...
<form name="writeForm" id="writeForm">
	<table border="1" cellspacing="0" cellpadding="5">
		...
		<tr>
			...
			<td><input type="text" name="id" id="id_write" placeholder="아이디 입력">
		...
		<tr>
			...
			<input type="text" name = "addr2" id="addr2" placeholder="상세주소입력" size = "50">
...
<script type="text/javascript" src="/SpringProject/js/member_jQuery.js">
